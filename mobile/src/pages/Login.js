...
export default class Login extends Component {
    ...
    /**Alteração do objeto state */
    handleInputChange = username => {
        this.setState({ username })
    }

    /**Grava o Login informado no input no storage do celular */
    handleLogin = async () => {
    ...
    /**Função para navegar para a timeline */
    navigateToTimeline = () => {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.content}>
                    ...
                    />
                    <TouchableOpacity style={styles.button} onPress={this.handleLogin}><Text style={styles.buttonText}>Entrar</Text></TouchableOpacity>
                </View>
            </View>
        )
    }
